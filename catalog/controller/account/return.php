...
class ControllerAccountReturn extends Controller {
	...
	protected function validate() {
		...
		///sharma for pos
		if ($this->cart->getReturnIdOfProduct($this->request->post['product_id'], $this->request->post['order_id'])) {
			$this->error['warning'] = 'Return Already Made, Please wait for action!';
		}
