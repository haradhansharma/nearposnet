	...
	public function info() {
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				if($this->cart->getReturnIdOfProduct($product['product_id'], $order_info['order_id'])){
					$existing_return_id = $this->cart->getReturnIdOfProduct($product['product_id'], $order_info['order_id']);
				}else{
					$existing_return_id = '';
				}

				if($existing_return_id){
					$rreturn = $this->url->link('account/return/info', 'return_id=' . $existing_return_id, true);
				}else{
					$rreturn = '';
