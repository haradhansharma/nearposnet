...
class ControllerExtensionModuleCategory extends Controller {
	public function index() {
		...
		if ($posapp_id || isset($this->request->get['route'])?$this->request->get['route']:'' == $posroute ) {

		$categories = $this->model_catalog_category->getCategories22(0);

		foreach ($categories as $category) {
			$children_data = array();

			if ($category['category_id'] == $data['category_id']) {
				$children = $this->model_catalog_category->getCategories22($category['category_id']);
