...
class ModelAccountOrder extends Model {
	...
	public function getTotalOrdersAmount() {
		$query = $this->db->query("SELECT sum(total) AS total FROM `" . DB_PREFIX . "order` o WHERE customer_id = '" . (int)$this->customer->getId() . "' AND o.order_status_id > '0' AND o.store_id = '" . (int)$this->config->get('config_store_id') . "'");
