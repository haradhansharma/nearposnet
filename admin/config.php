<?php
// HTTP
define('HTTP_SERVER', 'http://nearpos.net/admin/');
define('HTTP_CATALOG', 'http://nearpos.net/');

// HTTPS
define('HTTPS_SERVER', 'https://nearpos.net/admin/');
define('HTTPS_CATALOG', 'https://nearpos.net/');

// DIR
define('DIR_APPLICATION', '/home/sincehence/nearpos.net/admin/');
...
define('DIR_CATALOG', '/home/sincehence/nearpos.net/catalog/');
