...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_thumboption'])) {
			$data['config_thumboption'] = $this->request->post['config_thumboption'];
		} else {
			$data['config_thumboption'] = $this->config->get('config_thumboption');
		}

		$data['thumboptions'] = array();

		$options = $this->model_setting_setting->getOptions();
		...
		if (isset($this->request->post['config_agent_term_id'])) {
			$data['config_agent_term_id'] = $this->request->post['config_agent_term_id'];
		} else {
			$data['config_agent_term_id'] = $this->config->get('config_agent_term_id');
		}
