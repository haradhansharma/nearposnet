...
/// edit sharma for pos
			...
			if ($this->user->hasPermission('modify', 'sale/commission_order')) {
				$sale[] = array(
					'name'	   => $this->language->get('text_commission_order'),
					'href'     => $this->url->link('sale/commission_order', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			////sharma for pos
			if ($this->user->hasPermission('access', 'customer/agent')) {
				$customer[] = array(
					'name'	   => $this->language->get('text_agent'),
					'href'     => $this->url->link('customer/agent', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			if ($this->user->hasPermission('access', 'customer/agent_approval')) {
				$customer[] = array(
					'name'	   => $this->language->get('text_agentapproval'),
					'href'     => $this->url->link('customer/agent_approval', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			////sharma for pos
...
////sharma for pos
			if ($this->user->hasPermission('access', 'localisation/country') && $this->user->hasPermission('modify', 'localisation/country')) {
				$localisation[] = array(
...
////sharma for pos
			if ($this->user->hasPermission('access', 'localisation/zone')&& $this->user->hasPermission('modify', 'localisation/zone')) {
				$localisation[] = array(
