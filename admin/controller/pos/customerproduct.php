<?php
class ControllerPosCustomerProduct extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('pos/customerproduct');
		...
		$data['add'] = $this->load->controller('pos/customerproduct/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
	...
	/* 24 09 2019 */
		...
		$this->response->setOutput($this->load->view('pos/customerproduct', $data));
